...
_MB300_FIDUCIALS: list[tuple[str, float, float]] = [
    ("B1",  112.65*_MM,  66*_MM), ("C1",  112.65*_MM,      0), ("D1",  112.65*_MM, -66*_MM),
    ("B2",   37.55*_MM,  66*_MM), ("C2",   37.55*_MM,      0), ("D2",   37.55*_MM, -66*_MM),
    ("B3",  -37.55*_MM,  66*_MM), ("C3",  -37.55*_MM,      0), ("D3",  -37.55*_MM, -66*_MM),
    ("B4", -112.65*_MM,  66*_MM), ("C4", -112.65*_MM,      0), ("D4", -112.65*_MM, -66*_MM),
    ("A2",   75.1*_MM,  132*_MM), ("A3",        0,  132*_MM),  ("A4",  -75.1*_MM,  132*_MM),
    ("E2",   75.1*_MM, -132*_MM), ("E3",        0, -132*_MM),  ("E4",  -75.1*_MM, -132*_MM),
]
del _MM
